...
namespace Strego\GoogleBundle\Tests\DependencyInjection;
...
class StregoGoogleExtensionTest extends WebTestCase
{
    ...
    protected function setUp()
    {
        ...
        $reflectionProperty = new \ReflectionProperty(get_class($this->analytics), "trackerFactory");
        $reflectionProperty->setAccessible(true);
        $this->factory =  $reflectionProperty->getValue($this->analytics);
    }
    ...
    public function testDefaultTrackerSet(){
        $this->assertEquals("default",$this->factory->getDefaultTracker());
    }
